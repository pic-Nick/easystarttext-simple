package com.easystarttextsimple.ui_prefs
...
import com.easystarttextsimple.MY_PERMISSIONS_REQUEST_READ_CONTACTS
...
class ContactPreferenceDialog : PreferenceDialogFragmentCompat() {
    ...
    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<out String>, grantResults: IntArray) {
        ...
        when (requestCode) {
            MY_PERMISSIONS_REQUEST_READ_CONTACTS -> processPermissionRequest(
